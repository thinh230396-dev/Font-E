        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#171328] via-[#241841] to-[#43246d] px-6 pb-7 pt-6 text-white sm:px-7">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="flex min-w-0 items-start gap-4">
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-400/15 text-emerald-300 ring-1 ring-emerald-300/20">
                <Phone className="h-5 w-5" />
              </span>
              <div className="min-w-0">
                <p className="text-[9px] font-black uppercase tracking-[0.16em] text-violet-300">Liên hệ chi nhánh</p>
                <h2 className="mt-2 text-xl font-black tracking-tight sm:text-2xl">Gọi chi nhánh này?</h2>
