    ...
    <div className="role-shell role-shell--reception reception-workspace min-h-screen bg-brand-bg text-brand-text">
      ...
      {paymentAppointment && (
        <InvoiceDialog
          ...
          setPaymentAppointment={setPaymentAppointment}
          appointments={appointments}
          branchCode={branchCode}
          branchName={branchName}
          ...
          openLineCustomizer={openLineCustomizer}
          activeCatalog={activeCatalog}
          filteredCatalog={filteredCatalog}
          filteredArtTemplates={filteredArtTemplates}
          invoiceCategories={invoiceCategories}
          invoiceCategory={invoiceCategory}
          setInvoiceCategory={setInvoiceCategory}
          invoiceCatalogTab={invoiceCatalogTab}
          setInvoiceCatalogTab={setInvoiceCatalogTab}
          invoiceCatalogQuery={invoiceCatalogQuery}
          setInvoiceCatalogQuery={setInvoiceCatalogQuery}
          addCatalogItem={addCatalogItem}
          addArtServiceItem={addArtServiceItem}
          removeCatalogItem={removeCatalogItem}
          mergedAppointmentIds={mergedAppointmentIds}
          mergeAppointmentToBill={mergeAppointmentToBill}
          unmergeAppointmentFromBill={unmergeAppointmentFromBill}
          loyaltyPrograms={loyaltyPrograms}
          selectedPromoId={selectedPromoId}
          setSelectedPromoId={setSelectedPromoId}
          promoFeedback={promoFeedback}
          setPromoFeedback={setPromoFeedback}
          ...
          setSplitPaymentMode={setSplitPaymentMode}
